...
var theTests = []struct {
	...
	url                string // the path taht matches our route
	...
	// 	{key: "last_name", value: "Li"},
	// 	{key: "email", value: "me@here.com"},
	// 	{key: "phone", value: "323-797-6501"},
	// }, http.StatusOK},
}
...
func TestHandlers(t *testing.T) {
	...
	defer ts.Close() // when current function si finished, do defer things
...
func TestRepository_Reservation(t *testing.T) {
	...
	if rr.Code != http.StatusOK {
		t.Errorf("Reservation handler returned woring response code: got %d, wanted %d", rr.Code, http.StatusOK)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler returned woring response code: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
...
func TestRepository_PostReservation(t *testing.T) {
	...
	postedData.Add("phone", "1234556789")
	...
	// set header to specify what type the request is (a form post here)
	...
	if rr.Code != http.StatusSeeOther {
		t.Errorf("Reservation handler returned woring response code: got %d, wanted %d", rr.Code, http.StatusSeeOther)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler returned woring response code for missing post body: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler returned woring response code for invalid start date: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler returned woring response code for invalid end date: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler returned woring response code for invalid room id: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
	...
	if rr.Code != http.StatusSeeOther {
		t.Errorf("Reservation handler returned woring response code for invalid data: got %d, wanted %d", rr.Code, http.StatusSeeOther)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler failed when trying to inserting reservation: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("Reservation handler failed when trying to inserting restriction: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
}
